...
export const TracingBeam = ({ children, className }) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn('relative mx-auto h-full w-full max-w-6xl px-4', className)}
    >
      <div
        dir="ltr"
        className="absolute -left-4 top-24 hidden md:-left-20 xl:block"
      >
        <motion.div
          transition={{
            duration: 0.2,
        ...
        >
          <motion.div
            ...
            className="h-2 w-2 rounded-full border border-cyan-400 bg-white"
          />
        </motion.div>
        <svg
